...
const navItems = [
  ...
  { href: '/manage/hazard', label: 'ヒヤリハット' },
  { href: '/manage/ky', label: 'KY活動' },
  { href: '/manage/leave', label: '休暇申請' },
  { href: '/manage/subcontractors', label: '協力会社' },
  { href: '/manage/equipment', label: '機械管理' },
  { href: '/manage/photos', label: '写真検索' },
  { href: '/manage/reports', label: '日報管理' },
  { href: '/manage/messages', label: 'メッセージ', showUnreadBadge: true },
  { href: '/manage/timeclock', label: '打刻管理' },
  { href: '/manage/overtime', label: '労働時間' },
  { href: '/manage/attendance', label: '出面表' },
  { href: '/manage/work-plans', label: '作業計画' },
  { href: '/manage/export', label: 'エクスポート' },
  { href: '/manage/audit', label: '操作ログ' },
